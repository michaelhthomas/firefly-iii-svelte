 ...
 */
export function instanceOfRecurrenceStore(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "type" in value;
    isInstance = isInstance && "title" in value;
    isInstance = isInstance && "firstDate" in value;
    isInstance = isInstance && "repeatUntil" in value;
...
export function RecurrenceStoreToJSON(value?: RecurrenceStore | null): any {
    ...
    return {
        ...
        'repeat_until': (value.repeatUntil === null ? null : value.repeatUntil.toISOString().substring(0,10)),
