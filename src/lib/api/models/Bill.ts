...
export function instanceOfBill(value: object): boolean {
    ...
    isInstance = isInstance && "amountMin" in value;
    isInstance = isInstance && "amountMax" in value;
    isInstance = isInstance && "date" in value;
    isInstance = isInstance && "repeatFreq" in value;
...
export function BillFromJSONTyped(json: any, ignoreDiscriminator: boolean): Bill {
    ...
    return {
        ...
        'paidDates': !exists(json, 'paid_dates') ? undefined : ((json['paid_dates'] as Array<any>).map(BillPaidDatesInnerFromJSON)),
    };
}
